<?php
/**
 * Mibizum_Sync_Block_Frontend_SmartItem
 *
 ...
 */
class Mibizum_Sync_Block_Frontend_SmartItem extends Mage_Core_Block_Template
{
    /** @return array|null */
    ...
    {
        return Mage::helper('mibizum_sync/smartItem')->fetchSmartItems(200);
    }

    /** Configurable listing title (Ingredientes / Próximamente / I+D / Raw...). */
    public function getListTitle()
    {
        return Mage::helper('mibizum_sync/smartItem')->getListTitle();
    }

    /** Public ficha URL for a given slug. */
    public function getFichaUrl($slug)
    {
        return Mage::helper('mibizum_sync/smartItem')->getFichaUrl($slug);
    }
